...
// facetGitHubURL is the canonical public repo for the Facet project. Referenced
// from both the Help menu and the About settings page.
const facetGitHubURL = "https://github.com/firstlayer-xyz/Facet"
